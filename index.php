    ...
    <div class="ads-grid">
            ...
            <?php while($row = mysqli_fetch_assoc($result)): ?>
                <div class="ad-card">
                    ...
                    <div class="ad-content">
                        ...
                        <p style="font-size: 0.85rem; color: #666; height: 35px; overflow: hidden;"><?php echo mb_substr($row['description'], 0, 60, 'utf-8'); ?>...</p>
        ...
        <?php else: ?>
            <div style="grid-column: 1/-1; text-align: center; padding: 50px; background: white; border-radius: 12px;">
                <h3>🔍 لا توجد إعلانات تطابق بحثك حالياً.</h3>
                <a href="index.php" style="color: var(--accent);">استكشف كل الإعلانات</a>
            </div>
        <?php endif; ?>
    </div>
</div>
